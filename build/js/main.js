...
/* harmony import */ var _slicker_slicker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./slicker/slicker */ "./src/js/slicker/slicker.js");

var slider = new _slicker_slicker__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
var myOwnSlicker = /*#__PURE__*/function () {
  function myOwnSlicker() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, myOwnSlicker);
  ...
  _createClass(myOwnSlicker, [{
    key: "setSliderItems",
    value: function setSliderItems(wrapper) {
      var _this = this;

      var sliderItem = wrapper.children;
      sliderItem.forEach(function (item, i) {
        _this.default.items.push({
          item: item,
          position: i,
          mLeft: 0
        });
    ...
    key: "setWidthForWrapper",
    value: function setWidthForWrapper(wrapCount, slideToShow) {
      var slideCount = wrapCount.children.length;
      wrapCount.style.display = 'flex';
      wrapCount.style.width = "".concat(slideCount * 100 / slideToShow, "%");
      wrapCount.children.forEach(function (item) {
        item.style.width = "".concat(100 / slideToShow, "%");
        var img = item.querySelector('img');
        img.style.width = '100%';
      });
    }
  }, {
    key: "buildArrowsForSlider",
    value: function buildArrowsForSlider(wrapper) {
    ...
    key: "buildDotsForSlider",
    value: function buildDotsForSlider(wrapper, isDote, slideToShow) {
      if (!isDote) return;
      var dotsWrapper = wrapper.parentElement,
      ...
      for (var i = 0; i < wrapLenght / slideToShow; i++) {
    ...
    key: "dotsActive",
    value: function dotsActive(dotsItem, slideCount) {
      var slideDots = dotsItem.children;
      slideDots.forEach(function (item, i) {
    ...
    key: "setDataAttr",
    value: function setDataAttr(wrapper) {
      wrapper.children.forEach(function (item, i) {
        item.setAttribute('data-id', i + 1);
      });
    }
  }, {
    key: "markSlideItem",
    value: function markSlideItem(wrapper) {
      var slideItemMark = wrapper.children;
      slideItemMark[0].classList.add('first');
      slideItemMark[slideItemMark.length - 1].classList.add('last');
    }
  }, {
    key: "dotsAction",
    value: function dotsAction(wrapper, dotsList) {
      var _this2 = this;

      dotsList.forEach(function (item, i) {
        item.addEventListener('click', function (e) {
          dotsList.forEach(function (dotIndex) {
            dotIndex.classList.remove('dot-active');
          });
          e.target.classList.add('dot-active');
          wrapper.style.marginLeft = "0%";
          wrapper.style.marginLeft = "-".concat(i * 100, "%");
          _this2.default.count = i;
        });
      });
    }
  }, {
    key: "arrowEvent",
    value: function arrowEvent(arrows, wrapper, slideCount, slideToShow) {
      var _this3 = this;
      ...
      arrows.forEach(function (item) {
        item.addEventListener('click', function (e) {
          ...
          if (target.classList.contains('next')) {
            ...
            slideCount++;
            _this3.default.count = slideCount;
          ...
          wrapper.style.marginLeft = "".concat(marginLeft, "%");

          _this3.dotsActive(document.querySelector('.dots-list'), _this3.default.count);
        });
      });
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (myOwnSlicker);
